...
class CollisionHandler:
    ...
    def check_collisions(self, ball):
        """Checks for all types of collisions when the ball is on the ground."""
    ...
    def _check_player_collisions(self, ball):
        """Handles collisions between balls and players."""
    ...
    def _eject_ball_from_collider(self, ball, player_position):
        """Ejects the ball when it overlaps with a player."""
    ...
    def _check_garden_bed_collisions(self, ball):
        """Handles collisions with garden beds."""
    ...
    def _check_goal_collisions(self, ball):
        """Handles collisions with goal zones, reducing player lives."""
    ...
    def _handle_ball_deflection(self, ball, player):
        """Deflects the ball upon hitting a player."""
